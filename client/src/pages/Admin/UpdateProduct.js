...
const UpdateProduct = () => {
  ...
  const getAllCategory = async () => {
    try {
      ...
      console.log(error);
      toast.error("Algo salio mal al obtener la categoria");
    }
  };
  ...
  const handleDelete = async () => {
    try {
      let answer = window.prompt("Estas seguro de que queires eliminar el producto?");
      if (!answer) return;
            ...
            <div className="m-1 w-75">
              ...
              <div className="mb-3">
                {photo ? (
                  ...
                  <div className="text-center">
                    <img
                      src={`${process.env.REACT_APP_PORT_BACK}/api/v1/product/product-photo/${id}`}
                      alt="product_photo"
                      height={"200px"}
                      className="img img-responsive"
                    />
