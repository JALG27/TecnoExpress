              ...
              <p className="text-center">
                {cart?.length
                  ? `Tienes ${cart.length} productos en tu carrito ${
                      auth?.token ? "" : "poravor inicia sesion para verificacion !"
                    }`
        ...
        <div className="container ">
          <div className="row ">
            ...
            <div className="col-md-5 cart-summary ">
              ...
              <p>Total | Revision | Pago</p>
              <hr />
              <h4>Total : {totalPrice()} </h4>
              {auth?.user?.address ? (
                <>
                  <div className="mb-3">
                    <h4>Direccion proporcionada</h4>
                ...
                <div className="mb-3">
                  {auth?.token ? (
                    ...
                    >
                      Porfavor inicia sesion para revision
                    </button>
                  )}
                </div>
              )}
              <div className="mt-2">
                {!clientToken || !auth?.token || !cart?.length ? (
                  ...
                  <>
                    ...
                    >
                      {loading ? "Procesando..." : "Realiza el pago"}
                    </button>
                  </>
                )}
              </div>
